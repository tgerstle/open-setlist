...
export default {
  ...
  safelist: [
    ...
    { pattern: /ring-(blue|sky|fuchsia|orange|red|amber|indigo|slate|purple|emerald|teal|pink|lime|cyan|yellow|zinc|stone|violet|rose|green)-(300)/, variants: ['group-hover'] }
  ],
  theme: {
    extend: {
      colors: {
