...
export function ShowDetailDrawer({ show, onClose }: ShowDetailDrawerProps) {
  ...
  const isTicketProvider = (url: string) => {
    ...
    const fallbackProviders = "axs.com,ticketmaster.com,venuepilot.com,eventbrite.com,etix.com,ticketweb.com,dice.fm,pabsttheatergroup.com,livenation.com";
    const rawProviders = import.meta.env?.PUBLIC_TICKET_PROVIDERS || fallbackProviders;
