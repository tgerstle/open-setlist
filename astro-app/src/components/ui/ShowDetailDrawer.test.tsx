...
describe('ShowDetailDrawer Overlay', () => {
  ...
  it('updates selectedShowStore and creates dynamic URLs', async () => {
    ...
    // Render Drawer
    render(<ShowDetailDrawer show={mockShow} onClose={() => selectedShowStore.set(null)} />);
    ...
    expect(spotifyLink).toHaveAttribute('href', 'https://open.spotify.com/search/Dandy%20Warhols/artists');
