...
export function ShowPill({ show, onClick }: ShowPillProps) {
	...
	if (!show.venue_short_name && venueInitials.length > 3) {
		...
		else if (venueInitials.toLowerCase().includes("pabst"))
			venueInitials = "PT";
		else if (venueInitials.toLowerCase().includes("turner"))
			venueInitials = "TH";
		else if (venueInitials.toLowerCase().includes("riverside"))
			venueInitials = "RT";
		else if (venueInitials.toLowerCase().includes("cactus"))
			venueInitials = "CC";
		else if (venueInitials.toLowerCase().includes("shank"))
			venueInitials = "SH";
		else if (venueInitials.toLowerCase().includes("cooperage"))
			venueInitials = "CO";
		else if (venueInitials.toLowerCase().includes("x-ray"))
			venueInitials = "XR";
